...
export default function PlaylistDetail() {
         ...
         <div className="pt-[50px]  relative">
            <div className="max-h-[calc(90vh-50px)] w-[700px] max-w-[80vw] overflow-auto">
               <Button
                  ...
                  variant={"primary"}
                  className={`rounded-full ${theme.content_bg} absolute top-0 right-15px`}
               >
                  Save
   ...
   useEffect(() => {
    console.log('playlistSongIndexes ', playlistSongIndexes);
    
      setSelectedSongs(() =>
         playlistSongIndexes.map((songIndex) => userSongs[songIndex] as Song)
      );
   }, [playlistSongIndexes]);
  ...
  //  console.log("check playlist detail", playlistInStore);
