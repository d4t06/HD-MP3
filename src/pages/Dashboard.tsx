...
import Skeleton, { PlaylistSkeleton, SongItemSkeleton } from "../components/skeleton";
...
export default function DashBoard() {
   ...
   const handleSelectAll = () => {
      selectedSongs.length < adminSongs.length  ? setSelectedSongs(adminSongs) : setSelectedSongs([]);
   };
