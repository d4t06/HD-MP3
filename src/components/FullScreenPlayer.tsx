    ...
    >
      ...
      <div className="h-[calc(100vh-90px)]">
          ...
          <div className={classes.header}>
            ...
            >
              ...
              <MyPopup>
                ...
                <MyPopupContent className="top-[calc(100%+8px)] right-0 z-[99]" animationClassName="origin-top-right">
        ...
        {isOpenFullScreen && activeTab === "Lyric" && !idle && (
          ...
          >
            {currentSong.name} - <span className="opacity-50">{currentSong.singer}</span>
          </p>
        )}
      </div>
    </div>
