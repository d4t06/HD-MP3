...
import { ChevronDownIcon, Cog6ToothIcon, HeartIcon } from "@heroicons/react/24/outline";
                  ...
                  {useMemo(
                    () => (
                      <ScrollText
                        ...
                        autoScroll
                        classNames={`${
                          activeTab === "Playing" ? "text-[24px] leading-[30px]" : "text-[20px]"
                        } font-[500]`}
                  ...
                  {useMemo(
                    () => (
                      <ScrollText
                        ...
                        autoScroll
                        classNames={`${
                          activeTab === "Playing" ? "text-[22px]" : "text-[16px] text-gray-500"
                        } font-[400]`}
