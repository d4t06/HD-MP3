...
export default function LyricEditor({ audioRef, theme, song, admin, lyric }: Props) {
   ...
   const handleNavigateBack = () => {
      if (isChange) {
         setIsOpenModal("confirm-navigate");
      } else navigateBack();
   };
   ...
   const ctaComponent = (
      <div className={`${classes.ctaContainer} ${text}`}>
         <div className="left flex flex-wrap gap-[10px]">
            <button
               onClick={() => setIsOpenModal("add-base-lyric")}
               className={classes.button}
            >
...
window after doing something */}
            ...
            {isPlaying ? (
               ...
               <Button
                  ...
                  onClick={play}
                  className={
                     classes.button + (isPlaying || !isCanPlay ? classes.disable : "")
                  }
               >
                  Play
               </Button>
            ...
            <Button
               ...
               className={
                  classes.button +
                  (!realTimeLyrics.length || !baseLyricArr.length ? classes.disable : "")
               }
            >
            ...
            <Button
               ...
               className={
                  classes.button +
                  (!isClickPlay || !baseLyricArr.length ? classes.disable : "")
               }
            >
         ...
         <button onClick={() => setIsOpenModal("tutorial")}>
   ...
   return (
      <div className={`${loading ? "opacity-[0.6] pointer-events-none" : ""}`}>
         ...
         <Button
            ...
            variant={"primary"}
            onClick={() => setIsOpenModal("delete-lyric")}
         >
            Delete
         </Button>
         ...
         {!!isOpenModal && (
            <Modal
               ...
               classNames="w-[700px] max-w-[calc(100vw-40px)]"
            >
               {renderModal}
            </Modal>
         )}
