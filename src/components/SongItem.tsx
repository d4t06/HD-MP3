...
import { generatePlaylistAfterChangeSong, generatePlaylistAfterChangeSongs, handleTimeText, initSongObject, updatePlaylistsValue, updateSongsListValue } from "../utils/appHelpers";
      ...
      <div className="w-[200px]">
        ...
        {data.by != "admin" && (
          <>
            ...
            {data.lyric_id ? (
              <Button className={`${theme.content_hover_text}`} variant={"list"} onClick={() => handleOpenModal("edit")}>
