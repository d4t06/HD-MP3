...
function SongMenu({
   ...
   const { actuallySongs, removeFromQueue, addToQueue } = useActuallySongsStore();
   ...
   const classes = {
      ...
      menuItem: `hover:bg-${theme.alpha} ${theme.content_hover_text} max-[549px]:!bg-transparent pl-[12px] rounded-[4px]`,
      ...
      <>
         {isOnMobile ? (
            <Button
               ...
               variant={"list"}
               onClick={() => handleOpenModal("add-to-playlist")}
            >
                           ...
                           {userPlaylists.map((playlist, index) => {
                              ...
                              return (
                                 <li
                                    key={index}
                                    onClick={() =>
                                       !isAdded && handleAddSongToPlaylist(playlist)
                                    }
                  ...
                  <>
                     ...
                     <Link to={`edit/${songData.id}`}>
                        <Button className={` ${classes.menuItem} `} variant={"list"}>
                           ...
                           {songData.lyric_id ? "Edit lyric" : "Add lyric"}
                        </Button>
                     </Link>
